...
class HospitalPatientRounding(models.Model):
    ...
    ovulation_start = fields.Datetime(string="Start", required=True)
    ovulation_end = fields.Datetime(string="End", required=True)
    ...
    ovulation = fields.Selection([('n', 'Status Quo'),
                                  ('i', 'Improving'),
                                  ('w', 'Worsening')],
                                 string="Ovulation")
