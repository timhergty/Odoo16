...
class HospitalPatientDiseases(models.Model):
    _name = 'hospital.patient.diseases'
    _description = 'hospital patient diseases'

    pathelogh_id = fields.Many2one('hospital.pathology', 'Disease')
    ...
    physician_id = fields.Many2one('hospital.patient', 'Doctor')
