...
class HospitalHealthServicesInvoice(models.TransientModel):
    _name = 'hospital.health.service.invoice'
    _description = 'Hospital health service invoice'

    def create_hospital_service_invoice(self):
        active_id = self._context.get('active_id')
        lab_req_obj = self.env['hospital.health_service']
        ...
        invoice_vals = {
            'name': self.env['ir.sequence'].next_by_code('hospital_health_service_inv_seq'),
