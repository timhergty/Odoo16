...
class HospitalPatientEvaluation(models.Model):
    ...
    _description = 'Hospital Patient Evaluation'
    ...
    signs_and_symptoms_ids = fields.One2many('hospital.signs.and.symptoms', 'patient_evaluation_id',
                                             'Signs and Symptoms')
    ...
    secondary_conditions_ids = fields.One2many('hospital.secondary_condition', 'patient_evaluation_id',
                                               'Secondary Conditions')
    diagnostic_hypothesis_ids = fields.One2many('hospital.diagnostic_hypothesis', 'patient_evaluation_id', 'Procedures')
    procedure_ids = fields.One2many('hospital.directions', 'patient_evaluation_id', 'Procedures')
